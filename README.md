...
현장 출퇴근·서류 제출·공수 정산을 하나로 묶은 웹 시스템.
...
| `admin.html` | 관리자 — 대시보드, 출퇴근, 공수계산기, 서류함, 공지, 게시판, 구인, 근로자, 기준정보 |
...
| **직영팀장** | 담당 팀 범위 — 출퇴근 입력·승인, 공수계산기, 서류 확인, 공지, 구인 |
...
- **국민연금·건강보험** 은 당월 출퇴근일수(기본 8일) 또는 근로시간(60시간) 기준으로 자동 판정하며, 도달 임박 시 경고 표시
